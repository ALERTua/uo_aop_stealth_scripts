...
# COOLDOWNS
RESULT_DELAY = 250 + tools.server_ping_average() * 2
SKILL_COOLDOWN = 3000 + RESULT_DELAY
...
TYPE_ID_TOOL_MORTAR_PESTAL = 0x0E9B
TYPE_IDS_TOOL = [
    TYPE_ID_TOOL_FISHING_POLE,
    TYPE_ID_TOOL_PICKAXE,
    TYPE_ID_TOOL_MORTAR_PESTAL,
]
TYPE_ID_TOOL_TREE_CUTTING = [
    TYPE_ID_HATCHET,
    *TYPE_ID_AXES,
]
